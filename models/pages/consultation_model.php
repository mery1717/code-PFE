...
<body onmousemove="temps=0" onload='time_out();'>
 <?php
...
echo "<body>
     <form name='myForm' id='myForm' method='post' action='http://localhost/codePFE/models/consultation_resultat.php'> 
     ...
     <option value='' class='center'>=====Niveau3=====</option>" ;
       echo "</select> </td>
         ...
         <tr>
            ...
            <td> <select name='magasinSelectionee' id='magasin'>
